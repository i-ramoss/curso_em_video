...
if difference_between_years == 0:
    ...
    print(
        "You must enlist for military service in {} years.".format(
            18 - difference_between_years
        )
    )

elif difference_between_years > 18:
    print(
        "It has been {} years since your military enlistment.".format(
            difference_between_years - 18
        )
    )
