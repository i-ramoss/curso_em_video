...
if (value_01 > value_02): print('The first value, {}, is higher!\n'.format(value_01))

elif (value_01 < value_02): print('The second value, {}, is higher!\n'.format(value_02))

else: print('There isn\'t higher value, the numbers are the same!') 