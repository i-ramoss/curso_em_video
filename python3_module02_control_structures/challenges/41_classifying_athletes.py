...
if athlete_age <= 9:
    print("Your category is: {}".format(categories[0]))
elif athlete_age <= 14:
    print("Your category is: {}".format(categories[1]))
elif athlete_age <= 19:
    print("Your category is: {}".format(categories[2]))
elif athlete_age <= 20:
    print("Your category is: {}".format(categories[3]))
else:
    print("Your category is: {}".format(categories[4]))
