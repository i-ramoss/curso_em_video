...
print('The hypotenuse of the right triangle formed by opposite side {:.1f} and adjacent side {:.1f} is {:.1f}'.format(opposite_side, adjacent_side, hypot(opposite_side, adjacent_side)))
